...
namespace soclib {
   namespace common {
      ...
      void MicroBlazeIss::setDataResponse(bool error, uint32_t data)
      {
         ...
         default:
#if 0
            // It looks like I did not understood how this works, ...
            fprintf(stderr, "Unhandled memory access request, this sucks\n");
            exit(EXIT_FAILURE);
#endif
            break;
         }
      ...
      /*\
       * Bare copy of this comment from the mips.cc stuffs, as a reminder
