...
int _main(int argc, char *argv[])
{
	...
	soclib::common::MappingTable maptab(32, IntTab(8), IntTab(3), 0x00300000);
	...
	std::cout << maptab.getCacheabilityTable() << std::endl;
	std::cout << maptab.getRoutingTable(IntTab(), -1) << std::endl;
