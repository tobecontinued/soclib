	...
	namespace caba 
	{
		...
		private:
			...
			VirtualDspinRouter<data_size, io_mask_offset, io_mask_size, io_number_offset, io_number_size, 
						x_addressing_offset, x_addressing_size, y_addressing_offset, y_addressing_size, eop_offset, broadcast_offset, in_fifo_size, out_fifo_size> ** VirtualDspinRouters;
