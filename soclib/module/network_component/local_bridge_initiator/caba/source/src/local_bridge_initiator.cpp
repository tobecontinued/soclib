...
#include "../include/local_bridge_initiator.h"
#include <iostream>
#include <time.h>
...
LocalBridgeInitiator::LocalBridgeInitiator(sc_module_name	insname,
                            bool            alloc_init,
...
//	transition             //
////////////////////////////////
void LocalBridgeInitiator::transition()       
{
	if ( p_resetn == false ) 
	{ 
		if(m_alloc_init)
...
/////////// RING RSP FSM ////////////////////////
	...
	switch( r_ring_rsp_fsm ) 
	{
		case RSP_IDLE:  
		{
			...
			bool Local = m_lt[rsrcid];    

			if ( p_ring_in.rsp_rok.read() ) 
			{           

				if ( !Local && m_rsp_fifo.wok() )  // response packet to external initiator
				{
					r_ring_rsp_fsm = GATE;
					rsp_fifo_put  = true;
				...
				{
					if(Local && p_ring_in.rsp_wok.read())            
						r_ring_rsp_fsm = RING;  
				}       
			} 
		}
...
///////////////////////////////////////////////////////////////////
void LocalBridgeInitiator::genMealy_cmd_grant()
///////////////////////////////////////////////////////////////////
{    
	switch( r_ring_cmd_fsm ) 
	{
...
///////////////////////////////////////////////////////////////////
void LocalBridgeInitiator::genMealy_rsp_grant()
///////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////
void LocalBridgeInitiator::genMoore_rsp_fifo_out()
///////////////////////////////////////////////////////////////////
{
...
///////////////////////////////////////////////////////////////////
void LocalBridgeInitiator::genMealy_rsp_in()
///////////////////////////////////////////////////////////////////
{
	switch( r_ring_rsp_fsm ) 
	{
		...
		{                 
			...
			p_ring_out.rsp_r = p_ring_in.rsp_rok.read() && ((!Local && m_rsp_fifo.wok()) || (Local && p_ring_in.rsp_wok.read()));
		}
		break;
...
///////////////////////////////////////////////////////////////////
void LocalBridgeInitiator::genMealy_rsp_out()
///////////////////////////////////////////////////////////////////
{
...
///////////////////////////////////////////////////////////////////
void LocalBridgeInitiator::genMealy_cmd_in()
///////////////////////////////////////////////////////////////////
{
...
///////////////////////////////////////////////////////////////////
void LocalBridgeInitiator::genMealy_cmd_out()
///////////////////////////////////////////////////////////////////
{
