...
#ifndef BRIDGE_INITIATOR_H_
#define BRIDGE_INITIATOR_H_
...
class BridgeInitiator 
	: public soclib::caba::BaseModule
{

protected:
	SC_HAS_PROCESS(BridgeInitiator);
...
public:
    ...
    // constructor
    BridgeInitiator(sc_module_name	insname,
                            bool                alloc_init,
