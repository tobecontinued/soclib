...
#ifndef HALF_GATEWAY_INITIATOR_H_
#define HALF_GATEWAY_INITIATOR_H_
...
class HalfGatewayInitiator 
	: public soclib::caba::BaseModule
{

protected:
	SC_HAS_PROCESS(HalfGatewayInitiator);
...
public:
    ...
    // constructor
	HalfGatewayInitiator(sc_module_name	insname,
                            bool                alloc_init,
...
#endif // HALF_GATEWAY_INITIATOR_H_
