...
#define tmpl(x) template<typename vci_param, int dspin_data_size, int dspin_fifo_size> x VciDspinNetwork<vci_param, dspin_data_size, dspin_fifo_size>
	...
	// DSPIN_Signals
	//
	s_req_NS = new soclib::caba::DspinSignals<dspin_data_size>*[height_network + 2];
	s_req_EW = new soclib::caba::DspinSignals<dspin_data_size>*[height_network + 2];
	s_req_SN = new soclib::caba::DspinSignals<dspin_data_size>*[height_network + 2];
	s_req_WE = new soclib::caba::DspinSignals<dspin_data_size>*[height_network + 2];
	...
	s_rsp_NS = new soclib::caba::DspinSignals<dspin_data_size>*[height_network + 2];
	s_rsp_EW = new soclib::caba::DspinSignals<dspin_data_size>*[height_network + 2];
	s_rsp_SN = new soclib::caba::DspinSignals<dspin_data_size>*[height_network + 2];
	s_rsp_WE = new soclib::caba::DspinSignals<dspin_data_size>*[height_network + 2];
	...
	t_target_wrapper    = new soclib::caba::VciDspinTargetWrapper<vci_param, dspin_data_size, dspin_fifo_size>**[height_network];
	...
	for( size_t y = 0; y < height_network + 2 ; y++ ){
		...
		t_target_wrapper[y]    = new soclib::caba::VciDspinTargetWrapper<vci_param, dspin_data_size, dspin_fifo_size>*[width_network];
		...
		s_req_RW[y] = soclib::common::alloc_elems<soclib::caba::DspinSignals<dspin_data_size> >("s_req_RW", width_network);
		s_req_WR[y] = soclib::common::alloc_elems<soclib::caba::DspinSignals<dspin_data_size> >("s_req_WR", width_network);
		s_rsp_RW[y] = soclib::common::alloc_elems<soclib::caba::DspinSignals<dspin_data_size> >("s_rsp_RW", width_network);
		s_rsp_WR[y] = soclib::common::alloc_elems<soclib::caba::DspinSignals<dspin_data_size> >("s_rsp_WR", width_network);

		for( size_t x = 0; x < width_network ; x++ ){
		    t_initiator_wrapper[y][x] = new soclib::caba::VciDspinInitiatorWrapper<vci_param, dspin_data_size, dspin_fifo_size>("t_initiator_wrapper", mt);
		    t_target_wrapper[y][x] = new soclib::caba::VciDspinTargetWrapper<vci_param, dspin_data_size, dspin_fifo_size>("t_target_wrapper", mt);

		    t_req_router[y][x] = new soclib::caba::DspinRouter<dspin_data_size, dspin_fifo_size>("t_req_router", ((y<<4) & 0xF0) | (x & 0x0F) );
		    t_rsp_router[y][x] = new soclib::caba::DspinRouter<dspin_data_size, dspin_fifo_size>("t_rsp_router", ((y<<4) & 0xF0) | (x & 0x0F) );
		}
	    }	    

	    s_req_NS[y] = soclib::common::alloc_elems<soclib::caba::DspinSignals<dspin_data_size> >("s_req_NS", width_network + 2);
	    s_req_SN[y] = soclib::common::alloc_elems<soclib::caba::DspinSignals<dspin_data_size> >("s_req_SN", width_network + 2);	    
	    s_req_EW[y] = soclib::common::alloc_elems<soclib::caba::DspinSignals<dspin_data_size> >("s_req_EW", width_network + 2);
	    s_req_WE[y] = soclib::common::alloc_elems<soclib::caba::DspinSignals<dspin_data_size> >("s_req_WE", width_network + 2);	    

	    s_rsp_NS[y] = soclib::common::alloc_elems<soclib::caba::DspinSignals<dspin_data_size> >("s_rsp_NS", width_network + 2);
	    s_rsp_SN[y] = soclib::common::alloc_elems<soclib::caba::DspinSignals<dspin_data_size> >("s_rsp_SN", width_network + 2);
	    s_rsp_EW[y] = soclib::common::alloc_elems<soclib::caba::DspinSignals<dspin_data_size> >("s_rsp_EW", width_network + 2);
	    s_rsp_WE[y] = soclib::common::alloc_elems<soclib::caba::DspinSignals<dspin_data_size> >("s_rsp_WE", width_network + 2);	    
