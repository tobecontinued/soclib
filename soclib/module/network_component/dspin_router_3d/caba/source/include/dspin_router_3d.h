...
#ifndef DSPIN_ROUTER_3D_H_
#define DSPIN_ROUTER_3D_H_
...
#define N_PORTS_2D 5
	...
	DspinRouter3d( sc_module_name  name,
		 const size_t    x,
		 const size_t    y,
		 const size_t    z,
	...
	const size_t		m_z_shift;
	const size_t		m_z_mask;
	const size_t		m_elevator_x;
	const size_t		m_elevator_y;
	const bool		m_broadcast_supported;
	const bool		m_is_elevator;
	const int		m_nports;
