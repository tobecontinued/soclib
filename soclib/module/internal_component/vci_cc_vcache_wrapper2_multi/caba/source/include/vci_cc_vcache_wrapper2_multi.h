/* -*- c++ -*-
 * File : vci_cc_vcache_wrapper2_multi.h
...
#ifndef SOCLIB_CABA_VCI_CC_VCACHE_WRAPPER2_MULTI_H
#define SOCLIB_CABA_VCI_CC_VCACHE_WRAPPER2_MULTI_H
...
class VciCcVCacheWrapper2Multi
////////////////////////////////////////////
    : public soclib::caba::BaseModule
{
    ...
    enum dcache_fsm_state_e {  
        ...
        DCACHE_ICACHE_INVAL_PA,     // 29
        DCACHE_DCACHE_INVAL_PA,     // 2a
    ...
    enum cleanup_fsm_state_e {
        CLEANUP_CMD,                // 00
        CLEANUP_ICACHE_RSP,         // 01
        CLEANUP_DCACHE_RSP,         // 02
    };
    ...
    enum transaction_type_e {
        ...
        TYPE_INS_SC_ACC  = 0x8,
        TYPE_DATA_TLB    = 0x9,
        TYPE_DATA_LL_ACC = 0xc,
        TYPE_DATA_SC_ACC = 0x10,
        TYPE_DATA_LL_D   = 0x14,
        TYPE_DATA_SC_D   = 0x18,
    };
...
protected:
    SC_HAS_PROCESS(VciCcVCacheWrapper2Multi);

public:
    VciCcVCacheWrapper2Multi(
...
#endif /* SOCLIB_CABA_VCI_CC_VCACHE_WRAPPER2_MULTI_H */
