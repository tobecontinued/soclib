 ...
 *
 */
#include "../include/vci_mem_cache2.h"
...
#define tmpl(x) template<typename vci_param> x VciMemCache2<vci_param>
      ...
      case WRITE_UPDATE:	// send a multi-update request to INIT_CMD fsm
        {
          ...
          if ( !r_write_to_init_cmd_req ) {
            ...
            r_write_fsm = WRITE_IDLE; // pkoi pas WRITE_RSP ?
          }
          break;
        }
        ///////////////
