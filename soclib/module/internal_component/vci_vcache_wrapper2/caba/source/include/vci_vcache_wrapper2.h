    ...
    : public soclib::caba::BaseModule
{
    ...
    enum dcache_fsm_state_e {  
        ...
        DCACHE_DTLB_INVAL_DONE,     // 11
        DCACHE_ICACHE_INVAL,        // 12
        DCACHE_DCACHE_INVAL,        // 13
        DCACHE_DCACHE_INVAL_DONE,   // 14
        DCACHE_WRITE_UPDT,          // 15
        DCACHE_WRITE_DIRTY,         // 16
        DCACHE_WRITE_REQ,           // 17
        DCACHE_MISS_WAIT,           // 18
        DCACHE_MISS_UPDT,           // 19
        DCACHE_UNC_WAIT,            // 1a
