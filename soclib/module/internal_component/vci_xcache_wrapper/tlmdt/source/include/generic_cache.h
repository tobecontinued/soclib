...
//////////////////////////////
inline bool miss(typename vci_param::addr_t ad ) const
    {
    uint32_t y = m_y[ad] ;
...
///////////////////////////////
inline typename vci_param::data_t read(typename vci_param:: addr_t ad ) const
    {
    uint32_t y = m_y[ad] ;
    uint32_t x = m_x[ad] ;
    return m_data[y][x] ;
...
inline uint32_t get_nlines() const
{
	return m_lines;
}

inline uint32_t get_nwords() const
{
	return m_words;
}

inline uint32_t get_yzmask() const
{
	return m_yzmask;
}
