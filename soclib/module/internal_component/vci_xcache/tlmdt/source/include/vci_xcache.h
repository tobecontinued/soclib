...
#ifndef __VCI_XCACHE_H__
#define __VCI_XCACHE_H__
...
private:
  ...
  soclib::tlmt::buffer<iss_t,vci_param> m_buf;
  ...
  sc_core::sc_time                                m_rsp_vci_time;
  ...
  sc_core::sc_time          m_send_time;

  //FIELDS OF A NULL TRANSACTION
  ...
  //FIELDS OF AN ACTIVITY STATUS TRANSACTION
  ...
  sc_core::sc_time       m_req_icache_time;
