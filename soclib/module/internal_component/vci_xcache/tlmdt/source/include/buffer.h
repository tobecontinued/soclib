...
buffer(int depth)
{
    ...
    m_time = new sc_core::sc_time[depth];
    m_depth = depth;
...
///////////////////////////////////////////////////
 inline void push(typename vci_param::addr_t ad, typename iss_t::DataAccessType ty, typename vci_param::data_t dt, sc_core::sc_time time)
{
...
///////////////////////////
 inline sc_core::sc_time getTime( )
{
    return m_time[m_ptr] ;
}
