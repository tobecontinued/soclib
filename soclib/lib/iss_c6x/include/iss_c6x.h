 ...
 *      adaptation of the iss wrapper to the tms320c62 processor
 *
 */
#ifndef _SOCLIB_ISS_C6X_H_
#define _SOCLIB_ISS_C6X_H_
...
public:
	...
	IssC6x( const std::string &name, uint32_t ident )
		: m_ident(ident),
		  m_name(name)
	{
	}
    ...
    virtual void getInstructionRequest(bool &req, uint32_t &addr) = 0;
    virtual void setInstruction(bool error, uint32_t val) = 0;
    virtual void setInstructionPacket() = 0;
    virtual bool isInstPacketReady() = 0;
