...
int _main (int argc, char *argv[])
{
  ...
  soclib::caba::VciAvalonInitiatorWrapper<vci_param, avalon_param> cache_wrapper("cache_wrapper");
  ...
  cache_wrapper.p_vci(vci_initiator_bus); 
  ...
  cache_wrapper.p_avalon(wrapper_switch);

  SwitchFabric.p_avalon_master[0](wrapper_switch);

  //connexion bus Avalon
  ...
  sc_trace(my_trace_file, cache_wrapper.r_fsm_state, "cache_wrapper_fsm");
  sc_trace(my_trace_file, cache_wrapper.r_read_burst_count, "cache_wrapper_r_read_burst_count");	
  sc_trace(my_trace_file, cache_wrapper.r_read_burstcount, "cache_wrapper_r_read_burstcount");	
  sc_trace(my_trace_file, cache_wrapper.r_cmd, "cache_wrapper_r_cmd");	
