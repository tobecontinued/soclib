...
int _main(int argc, char *argv[])
{
  ...
  // Signals
	...
	soclib::caba::Demapping<vci_param, NB_SAMPLES> demapping("demapping", NB_CYCLES);
	...
	demapping.p_clk(signal_clk);
	demapping.p_resetn(signal_resetn);
	demapping.p_to_ctrl(signal_fifo_to_ctrl);
	demapping.p_from_ctrl(signal_fifo_from_ctrl);
