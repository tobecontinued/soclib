...
int _main(int argc, char *argv[])
{
    ...
    vciDspinPlusNetwork.p_to_initiator[0][0](signal_vci_C00_I);
    vciDspinPlusNetwork.p_to_target[0][0](signal_vci_C00_T);
    ...
    vciDspinPlusNetwork.p_to_initiator[0][1](signal_vci_C01_I);
    vciDspinPlusNetwork.p_to_target[0][1](signal_vci_C01_T);
    ...
    vciDspinPlusNetwork.p_to_initiator[1][0](signal_vci_C10_I);
    vciDspinPlusNetwork.p_to_target[1][0](signal_vci_C10_T);
    ...
    vciDspinPlusNetwork.p_to_initiator[1][1](signal_vci_C11_I);
    vciDspinPlusNetwork.p_to_target[1][1](signal_vci_C11_T);
