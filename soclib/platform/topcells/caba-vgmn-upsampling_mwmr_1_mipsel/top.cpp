...
int _main(int argc, char *argv[])
{
  ...
  // Signals
	...
	soclib::caba::Upsampling<vci_param, NB_SAMPLES> upsampling("upsampling", NB_CYCLES);
	...
	upsampling.p_clk(signal_clk);
	upsampling.p_resetn(signal_resetn);
	upsampling.p_to_ctrl(signal_fifo_to_ctrl);
	upsampling.p_from_ctrl(signal_fifo_from_ctrl);
