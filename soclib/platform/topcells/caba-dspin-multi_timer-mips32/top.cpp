...
int _main(int argc, char *argv[])
{
	...
	soclib::caba::VciDspinNetwork<vci_param, 4, 4> vciDspinNetwork("vciDspinNetwork", maptab, 2, 2);
	...
	vciDspinNetwork.p_to_initiator[0][0](signal_vci_m0);
	vciDspinNetwork.p_to_initiator[0][1](signal_vci_m1);
	vciDspinNetwork.p_to_initiator[1][0](signal_vci_m2);
	vciDspinNetwork.p_to_initiator[1][1](signal_vci_m3);

	vciDspinNetwork.p_to_target[0][0](signal_vci_vcimultiram0);
	vciDspinNetwork.p_to_target[0][1](signal_vci_tty);
	vciDspinNetwork.p_to_target[1][0](signal_vci_vcitimer);
	vciDspinNetwork.p_to_target[1][1](signal_vci_vcilocks);
