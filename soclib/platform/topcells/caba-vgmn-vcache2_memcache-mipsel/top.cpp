...
int _main(int argc, char *argv[])
{
	...
	maptabx.add(Segment("xram" , MC_M_BASE , MC_M_SIZE , IntTab(0), true));
	maptabx.add(Segment("ptba" , PTD_ADDR  , TAB_SIZE  , IntTab(0), true));
	maptabx.add(Segment("reset", RESET_BASE, RESET_SIZE, IntTab(0), true));
	maptabx.add(Segment("excep", EXCEP_BASE, EXCEP_SIZE, IntTab(0), true));
	maptabx.add(Segment("text" , TEXT_BASE , TEXT_SIZE , IntTab(0), true));
