...
int main(void)
{
    ...
    mwmr_initialize_pointer(p_mwmr_out,   WIDTH, DEPTH, fifo_data_out,   lock_out  );
    ...
    /////////////////////////////////////////////////////////////
    printf("Sending the data to the synchronization component");
    putchar('\n');
    ...
    putchar('\n');
    mwmr_read(p_mwmr_out, data_out, WIDTH*DEPTH);
    for(i=0; i<NB_SAMPLES; i++) 
    {
       printf("data_out[%d] = %d\n",i, data_out[i]);
    }
