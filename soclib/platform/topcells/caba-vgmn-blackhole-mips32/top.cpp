...
int _main(int argc, char *argv[])
{
	...
	maptab.add(Segment("blackhole" , BLACKHOLE_BASE, BLACKHOLE_SIZE , IntTab(3), false));
	// Signals
	...
	soclib::caba::VciSignals<vci_param> signal_vci_blackhole("signal_vci_blackhole");
	...
	soclib::caba::VciBlackhole<vci_param> vciblackhole("vciblackhole");
	...
	vciblackhole.p_clk(signal_clk);
	vciblackhole.p_resetn(signal_resetn);
	vciblackhole.p_vci(signal_vci_blackhole);
	...
	vgmn.p_to_target[3](signal_vci_blackhole);
