...
int _main(int argc, char *argv[])
{
  ...
  maptab.add(Segment("tc4200", TC4200_BASE, TC4200_SIZE, IntTab(3), false)); 
  ...
  soclib::caba::VciSignals<vci_param> signal_vci_tc4200("signal_vci_tc4200");
  ...
  soclib::caba::Tc4200<vci_param> tc4200("tc4200", IntTab(3), maptab);
  ...
  tc4200.p_clk(signal_clk);
  tc4200.p_resetn(signal_resetn);
  tc4200.p_vci(signal_vci_tc4200);
  ...
  vgmn.p_to_target[3](signal_vci_tc4200);
