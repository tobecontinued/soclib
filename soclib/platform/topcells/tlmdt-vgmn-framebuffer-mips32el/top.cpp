...
int _main(int argc, char *argv[])
{
	...
	typedef soclib::common::Iss2Simhelper<soclib::common::Mips32ElIss> iss2_t;
	...
	// VCI_FRAMEBUFFER
	/////////////////////////////////////////////////////////////////////////////
	soclib::tlmdt::VciFrameBuffer<vci_param> vcifb("vcifb", IntTab(3), maptab, FB_WIDTH, FB_HEIGHT, FB_MODE); 
	...
	(*vgmn.p_to_target[3])(vcifb.p_vci);
