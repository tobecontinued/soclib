...
int sc_main(int argc, char **argv)
{
  ...
  soclib::common::ElfLoader loader("soft/bin4proc.soft");
  ...
  // VCI_VGMN 
  /////////////////////////////////////////////////////////////////////////////
  soclib::tlmt::VciVgmn<vci_param> vgmn(6,5,mapping_table,network_latence);
  ...
  // VCI_XCACHE 3
  /////////////////////////////////////////////////////////////////////////////
  soclib::tlmt::VciXcacheWrapper<soclib::common::MipsElIss,vci_param> mips2("mips2", soclib::common::IntTab(2), mapping_table, icache_size, 8, dcache_size, 8, simulation_time);

  mips2.p_vci(vgmn.m_RspArbCmdRout[2]->p_vci);

  /////////////////////////////////////////////////////////////////////////////
  // VCI_XCACHE 4
  /////////////////////////////////////////////////////////////////////////////
  soclib::tlmt::VciXcacheWrapper<soclib::common::MipsElIss,vci_param> mips3("mips3", soclib::common::IntTab(3), mapping_table, icache_size, 8, dcache_size, 8, simulation_time);

  mips3.p_vci(vgmn.m_RspArbCmdRout[3]->p_vci);
  ...
  soclib::tlmt::VciMwmrController<vci_param> tg_ctrl("tg_ctrl", mapping_table, soclib::common::IntTab(4), soclib::common::IntTab(3), read_depth, write_depth, n_read_channel, n_write_channel, n_config, n_status);

  tg_ctrl.p_vci_initiator(vgmn.m_RspArbCmdRout[4]->p_vci);
  ...
  soclib::tlmt::VciMwmrController<vci_param> ramdac_ctrl("ramdac_ctrl", mapping_table, soclib::common::IntTab(5), soclib::common::IntTab(4), read_depth, write_depth, n_read_channel, n_write_channel, n_config, n_status);

  ramdac_ctrl.p_vci_initiator(vgmn.m_RspArbCmdRout[5]->p_vci);
