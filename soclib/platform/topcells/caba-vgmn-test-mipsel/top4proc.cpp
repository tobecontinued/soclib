 ...
 **
 ** Generated by DSX on 2008-09-09 11:23:50.880817
 ** by alinev@rock
 ** MARKER_END
 **/
#include <systemc>
...
int _main(int argc, char **argv)
{
  ...
  ftime(&initial);
	...
	soclib::caba::VciMwmrController<soclib::caba::VciParams<4,8,32,1,1,1,8,1,1,1> >  ramdac_ctrl("ramdac_ctrl", mapping_table, soclib::common::IntTab(5), soclib::common::IntTab(4), 64, 96, 0, 1, 0, 0, 0, true);
	soclib::caba::VciMwmrController<soclib::caba::VciParams<4,8,32,1,1,1,8,1,1,1> >  tg_ctrl("tg_ctrl", mapping_table, soclib::common::IntTab(4), soclib::common::IntTab(3), 64, 0, 8, 0, 1, 0, 0, true);
	...
	soclib::caba::VciVgmn<soclib::caba::VciParams<4,8,32,1,1,1,8,1,1,1> >  vgmn0("vgmn0", mapping_table, 6, 5, network_latence, 8);
	...
	soclib::caba::VciXCache<soclib::caba::VciParams<4,8,32,1,1,1,8,1,1,1> >  xcache2("xcache2", mapping_table, soclib::common::IntTab(2), icache_size, 8, dcache_size, 8);
	soclib::caba::VciXCache<soclib::caba::VciParams<4,8,32,1,1,1,8,1,1,1> >  xcache3("xcache3", mapping_table, soclib::common::IntTab(3), icache_size, 8, dcache_size, 8);
	...
	soclib::caba::DCacheSignals mips2_p_dcache_to_xcache2_p_dcache("mips2_p_dcache_to_xcache2_p_dcache");
	soclib::caba::DCacheSignals mips3_p_dcache_to_xcache3_p_dcache("mips3_p_dcache_to_xcache3_p_dcache");
	...
	soclib::caba::ICacheSignals mips2_p_icache_to_xcache2_p_icache("mips2_p_icache_to_xcache2_p_icache");
	soclib::caba::ICacheSignals mips3_p_icache_to_xcache3_p_icache("mips3_p_icache_to_xcache3_p_icache");
	...
	soclib::caba::VciSignals<soclib::caba::VciParams<4,8,32,1,1,1,8,1,1,1> >  ramdac_ctrl_p_vci_initiator_to_vgmn0_p_to_initiator_5_("ramdac_ctrl_p_vci_initiator_to_vgmn0_p_to_initiator_5_");
	...
	soclib::caba::VciSignals<soclib::caba::VciParams<4,8,32,1,1,1,8,1,1,1> >  tg_ctrl_p_vci_initiator_to_vgmn0_p_to_initiator_4_("tg_ctrl_p_vci_initiator_to_vgmn0_p_to_initiator_4_");
	...
	soclib::caba::VciSignals<soclib::caba::VciParams<4,8,32,1,1,1,8,1,1,1> >  vgmn0_p_to_initiator_2__to_xcache2_p_vci("vgmn0_p_to_initiator_2__to_xcache2_p_vci");
	soclib::caba::VciSignals<soclib::caba::VciParams<4,8,32,1,1,1,8,1,1,1> >  vgmn0_p_to_initiator_3__to_xcache3_p_vci("vgmn0_p_to_initiator_3__to_xcache3_p_vci");

	// Component configure
	mips0.setCacheInfo(xcache0.getCacheInfo());
	mips1.setCacheInfo(xcache1.getCacheInfo());
	mips2.setCacheInfo(xcache2.getCacheInfo());
	mips3.setCacheInfo(xcache3.getCacheInfo());
	...
	mips2.p_clk(clock);
	mips2.p_dcache(mips2_p_dcache_to_xcache2_p_dcache);
	mips2.p_icache(mips2_p_icache_to_xcache2_p_icache);
	mips2.p_irq[0](*new sc_core::sc_signal<bool>("mips2_p_irq_0_"));
	mips2.p_irq[1](*new sc_core::sc_signal<bool>("mips2_p_irq_1_"));
	mips2.p_irq[2](*new sc_core::sc_signal<bool>("mips2_p_irq_2_"));
	mips2.p_irq[3](*new sc_core::sc_signal<bool>("mips2_p_irq_3_"));
	mips2.p_irq[4](*new sc_core::sc_signal<bool>("mips2_p_irq_4_"));
	mips2.p_irq[5](*new sc_core::sc_signal<bool>("mips2_p_irq_5_"));
	mips2.p_resetn(resetn);
	mips3.p_clk(clock);
	mips3.p_dcache(mips3_p_dcache_to_xcache3_p_dcache);
	mips3.p_icache(mips3_p_icache_to_xcache3_p_icache);
	mips3.p_irq[0](*new sc_core::sc_signal<bool>("mips3_p_irq_0_"));
	mips3.p_irq[1](*new sc_core::sc_signal<bool>("mips3_p_irq_1_"));
	mips3.p_irq[2](*new sc_core::sc_signal<bool>("mips3_p_irq_2_"));
	mips3.p_irq[3](*new sc_core::sc_signal<bool>("mips3_p_irq_3_"));
	mips3.p_irq[4](*new sc_core::sc_signal<bool>("mips3_p_irq_4_"));
	mips3.p_irq[5](*new sc_core::sc_signal<bool>("mips3_p_irq_5_"));
	mips3.p_resetn(resetn);
	ram0.p_clk(clock);
	...
	ramdac_ctrl.p_vci_initiator(ramdac_ctrl_p_vci_initiator_to_vgmn0_p_to_initiator_5_);
	...
	tg_ctrl.p_vci_initiator(tg_ctrl_p_vci_initiator_to_vgmn0_p_to_initiator_4_);
	...
	vgmn0.p_to_initiator[2](vgmn0_p_to_initiator_2__to_xcache2_p_vci);
	vgmn0.p_to_initiator[3](vgmn0_p_to_initiator_3__to_xcache3_p_vci);
	vgmn0.p_to_initiator[4](tg_ctrl_p_vci_initiator_to_vgmn0_p_to_initiator_4_);
	vgmn0.p_to_initiator[5](ramdac_ctrl_p_vci_initiator_to_vgmn0_p_to_initiator_5_);
	...
	xcache2.p_clk(clock);
	xcache2.p_dcache(mips2_p_dcache_to_xcache2_p_dcache);
	xcache2.p_icache(mips2_p_icache_to_xcache2_p_icache);
	xcache2.p_resetn(resetn);
	xcache2.p_vci(vgmn0_p_to_initiator_2__to_xcache2_p_vci);
	xcache3.p_clk(clock);
	xcache3.p_dcache(mips3_p_dcache_to_xcache3_p_dcache);
	xcache3.p_icache(mips3_p_icache_to_xcache3_p_icache);
	xcache3.p_resetn(resetn);
	xcache3.p_vci(vgmn0_p_to_initiator_3__to_xcache3_p_vci);
