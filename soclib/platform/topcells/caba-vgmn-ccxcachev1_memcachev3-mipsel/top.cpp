...
*/
  ...
  soclib::caba::VciLogger<vci_param> vci_logger0("vci_logger0",maptabp);
	...
	vgmnp("vgmnp",maptabp, 4, 3, 2, 8);

	soclib::caba::VciVgmn<vci_param> 
	vgmnc("vgmnc",maptabc, 5, 5, 2, 8);

	soclib::caba::VciVgmn<vci_param> 
	vgmnx("vgmnx",maptabx, 1, 1, 2, 8);
  ...
  xram.p_resetn(signal_resetn);
	...
	vgmnp.p_to_initiator[0](signal_vci_ini_rw_proc0);
	vgmnp.p_to_initiator[1](signal_vci_ini_rw_proc1);
	vgmnp.p_to_initiator[2](signal_vci_ini_rw_proc2);
	vgmnp.p_to_initiator[3](signal_vci_ini_rw_proc3);

	vgmnc.p_to_initiator[4](signal_vci_ini_memc);
	vgmnc.p_to_initiator[0](signal_vci_ini_c_proc0);
	vgmnc.p_to_initiator[1](signal_vci_ini_c_proc1);
	vgmnc.p_to_initiator[2](signal_vci_ini_c_proc2);
	vgmnc.p_to_initiator[3](signal_vci_ini_c_proc3);
	...
	vgmnc.p_to_target[2](signal_vci_tgt_proc2);
	vgmnc.p_to_target[3](signal_vci_tgt_proc3);
	vgmnc.p_to_target[4](signal_vci_tgt_cleanup_memc);
