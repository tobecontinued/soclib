 ...
 * Maintainer: wagner
 * 
 * File : avalon_switch_config.h dedicated to caba_avalon_framebuffer_nios2 platform
 * Date : 20/11/2008
 */
...
namespace soclib { namespace caba {
	...
	//=================== 1 Master  nios0 5  Slaves (multiram0 multiram1 vcitty  vcitimer fb )
	//
	//                   caba_avalon_framebuffer_nios2f platform
	//
	...
	SwitchFabricParam_Master[0]->route[4] =  4;	                  // nios0  -> fb	
	...
	// vcitty
	SwitchFabricParam_Slave[2]->route[0] =   0;	                  // vcitty  -> nios0
	...
	// vcitimer
	SwitchFabricParam_Slave[3]->route[0] =   0;	                  // vcitimer  -> nios0
	SwitchFabricParam_Slave[3]->route[1] =  -1;	                  // end
		
	SwitchFabricParam_Slave[3]->arbiter_n_master =  1;	         
	...
	SwitchFabricParam_Slave[4]->route[1] =  -1;	                  // end
		
	SwitchFabricParam_Slave[4]->arbiter_n_master =  1;	         

	SwitchFabricParam_Slave[4]->Base_Address = 0xB4200000;         	
	SwitchFabricParam_Slave[4]->Address_Span = 0x00100000;  
