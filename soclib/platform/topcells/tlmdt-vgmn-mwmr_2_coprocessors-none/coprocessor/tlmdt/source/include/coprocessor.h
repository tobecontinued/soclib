...
: public sc_core::sc_module
{
 ...
 public:
  std::vector<tlm_utils::simple_target_socket_tagged<Coprocessor,32,tlm::tlm_base_protocol_types> *> p_config;
  std::vector<tlm_utils::simple_target_socket_tagged<Coprocessor,32,tlm::tlm_base_protocol_types> *> p_status;

  std::vector<tlm_utils::simple_initiator_socket_tagged<Coprocessor,32,tlm::tlm_base_protocol_types> *> p_read_fifo;
  std::vector<tlm_utils::simple_initiator_socket_tagged<Coprocessor,32,tlm::tlm_base_protocol_types> *> p_write_fifo;
