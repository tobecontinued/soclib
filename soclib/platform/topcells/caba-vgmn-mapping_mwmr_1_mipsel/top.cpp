...
int _main(int argc, char *argv[])
{
  ...
  // Signals
	...
	soclib::caba::Mapping<vci_param, NB_SAMPLES> mapping("mapping", NB_CYCLES);
	...
	mapping.p_clk(signal_clk);
	mapping.p_resetn(signal_resetn);
	mapping.p_to_ctrl(signal_fifo_to_ctrl);
	mapping.p_from_ctrl(signal_fifo_from_ctrl);
