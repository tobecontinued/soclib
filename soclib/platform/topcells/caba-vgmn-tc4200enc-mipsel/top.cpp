...
int _main(int argc, char *argv[])
{
	...
	maptab.add(Segment("tc4200_enc", TC4200_ENC_BASE, TC4200_ENC_SIZE, IntTab(3), false)); 
	...
	soclib::caba::VciSignals<vci_param> signal_vci_tc4200_enc("signal_vci_tc4200_enc");
	...
	soclib::caba::Tc4200_enc<vci_param> tc4200_enc("tc4200_enc", IntTab(3), maptab);
	...
	tc4200_enc.p_clk(signal_clk);
	tc4200_enc.p_resetn(signal_resetn);
	tc4200_enc.p_vci(signal_vci_tc4200_enc);
	...
	vgmn.p_to_target[3](signal_vci_tc4200_enc);
	...
	for (int i = 0; i < ncycles ; i+=10000) {
		...
		std::cout << "Time elapsed: "<<i+10000<<" cycles." << std::endl;
	}
	sleep(5);
	return EXIT_SUCCESS;
#else
