...
_int_handler:
    addiu   $29,    $29,    -23*4   /* stack space reservation (19 registers to
 ...
 * copies of all the processor registers.
 ...
 * 2*4(ctx) $2   10*4(ctx) $10   18*4(ctx) $18   26*4(ctx) LO    34*4(ctx) tty_id + 0x80000000
