...
int _main(int argc, char *argv[])
{
  ...
  // Signals
	...
	soclib::caba::Fir128<vci_param, NB_SAMPLES> fir128("fir128", NB_CYCLES);
	...
	fir128.p_clk(signal_clk);
	fir128.p_resetn(signal_resetn);
	fir128.p_to_ctrl(signal_fifo_to_ctrl);
	fir128.p_from_ctrl(signal_fifo_from_ctrl);
