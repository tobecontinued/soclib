...
int _main(int argc, char *argv[])
{
	...
	ringp("ringp",maptabp, IntTab(), 2, 2, 1, 3);

	soclib::caba::VciSimpleRingNetwork<vci_param> 
	ringc("ringc",maptabc, IntTab(), 2, 2, 1, 1);

	soclib::caba::VciSimpleRingNetwork<vci_param> 
	ringx("ringx",maptabx, IntTab(), 2, 2, 1, 1);
	...
	ringp.p_to_initiator[0](signal_vci_ini_proc);
	...
	ringc.p_to_target[0](signal_vci_tgt_proc);
