...
{
public:
    sc_in<bool>     	                cmd_grant;
    sc_in<sc_uint<37> >                 cmd_data;   
    sc_in<bool>                         cmd_rok;
    sc_in<bool>                         cmd_wok;
    sc_in<bool>     	                rsp_grant;
    sc_in<sc_uint<33> >                 rsp_data;   
    sc_in<bool>                         rsp_rok;
    sc_in<bool>                         rsp_wok;
    
    RingIn(const std::string &name = sc_gen_unique_name("ring_in_"))
...
{
public:
    sc_out<bool>     	                cmd_grant;
    sc_out<sc_uint<37> >                cmd_data;   
    sc_out<bool>                        cmd_r;
    sc_out<bool>                        cmd_w;
    sc_out<bool>     	                rsp_grant;
    sc_out<sc_uint<33> >                rsp_data;   
    sc_out<bool>                        rsp_w;
    sc_out<bool>                        rsp_r;


    RingOut(const std::string &name = sc_gen_unique_name("ring_out_"))
		:   cmd_grant    ((name+"cmd_grant").c_str()),
                    cmd_data     ((name+"cmd_data").c_str()),
