...
#ifndef COMMON_MODULE_HOLDER_H
#define COMMON_MODULE_HOLDER_H
...
class ModuleHolder
{
    ...
    ModuleHolder(const ModuleHolder &);
    const ModuleHolder &operator=(const ModuleHolder &);

	static std::vector<ModuleHolder*> s_existing_modules;

public:
	ModuleHolder( BaseModule *mod );
	ModuleHolder( BaseModule &mod );
