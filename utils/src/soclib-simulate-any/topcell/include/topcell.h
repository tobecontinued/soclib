...
class TopCell
{
	...
	soclib::common::inst::Signal<sc_core::sc_clock> m_wrapped_clk;
	soclib::common::inst::Signal<sc_core::sc_signal<bool> > m_wrapped_resetn;
	...
	void cell_instanciate( const std::string &cell,
						   ...
						   soclib::common::inst::InstArg *args );
	void instanciateAll();
	soclib::common::Factory & get_factory( const std::string &cell );
	void finalize();
public:
